...
async def init_database_process(pool):
    ...
    async with pool.acquire() as conn:
        async with conn.cursor() as cur: 
            ...
            """, [
                ("bob", "bob123", "Bob", "88 Queensway, Admiralty, Hong Kong", "/imgs/a1.jpg", "+852 6123 4567", 0),
                ("alice", "alice123", "Alice", "27 Science Park Road, Shatin, Hong Kong", "/imgs/a2.jpg", "+852 6789 1234", 0),
                ("john", "john123", "John", "6 Lakeside Road, West Kowloon, Hong Kong", "/imgs/a3.jpg", "+852 5555 8888", 0)
            ])
